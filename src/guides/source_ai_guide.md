...
**重要**: 以下の3つのツールは独立しており、任意の順序で実行可能です

#### 3a. export_experience_insights
...
#### 3c. export_experience_preferences
...
**export_experience_insights/patterns/preferences**
