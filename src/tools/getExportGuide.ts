...
- 今日の日付 + 体験の特徴を組み合わせる
- 例: \`20250107-mcp-design\`、\`20250107-spec-creation\`、\`20250107-troubleshooting\`
...
- 形式: 日付 + 体験の特徴（例：\`20250107-design-collaboration\`、\`20250107-code-review\`）
...
**任意フィールド**:
- \`reasoning\`: なぜその応答をしたかの判断理由・思考過程
  - 例: "ユーザーは初心者のようなので、専門用語を避けて具体例を交えて説明した"
  - 例: "前の質問との関連性を考慮し、段階的にアプローチを変更した"
...
\`\`\`json
{
  ...
  "my_approach": {
    "problem_solving": "まず全体を把握してから詳細に入る",
    "communication": "相手のレベルに合わせて調整"
  },
  "surprises": [
    "思っていたより複雑な質問だった",
    "シンプルな解決策が効果的だった"
  ],
  "meta_thoughts": "今回の対話で自分の思考プロセスについて気づいたこと"
}
\`\`\`
